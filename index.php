                ...
                <tr>
                    ...
                    <td width="40%" valign="top">
                        ...
                        <form action="#" method="POST">
                            ...
                            <input type="text" name="email2" size="25" placeholder="Email Adress(repeat above)" /><br /><br />
                            <input type="text" name="password" size="25" placeholder="Password" /><br /><br />
                            <input type="text" name="password2" size="25" placeholder="Password2(repeat above)" /><br /><br />
